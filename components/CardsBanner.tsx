...
export type CardsBannerType = {
  frame?: ImageSourcePropType;
  ellipse3?: ImageSourcePropType;
  ellipse4?: ImageSourcePropType;
  undrawOnTheWayReSwjt1?: ImageSourcePropType;
  group61?: ImageSourcePropType;

  /** Style props */
  cardsBannerMarginTop?: number | string;
};
...
const CardsBanner = ({
  ...
  ellipse3,
  ellipse4,
  undrawOnTheWayReSwjt1,
  group61,
  cardsBannerMarginTop,
}: CardsBannerType) => {
  const cardsBannerStyle = useMemo(() => {
    return {
      ...getStyleValue("marginTop", cardsBannerMarginTop),
    };
  }, [cardsBannerMarginTop]);

  return (
    <View style={[styles.cardsbanner, cardsBannerStyle]}>
